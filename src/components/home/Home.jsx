...
const Home = () => {
  ...
  return (
    ...
    <div
      ref={ref}
      id="home"
      className="scroll-mt-20 w-11/12 py-5 mt-[6rem] max-w-[1260px] mx-auto flex flex-col-reverse md:flex-row gap-6 md:justify-between items-center min-h-[550px] relative"
    >
      {/*=========================== Left Container Side ===========================*/}
      <div
        className="flex-1 max-w-[500px] flex flex-col gap-2 justify-start md:justify-center md:items-start relative z-10"
