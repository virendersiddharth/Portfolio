...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className='scroll-mt-20 mt-10'>
        ...
        <p className='mx-auto w-fit text-center'>Please contact me directly at {" "} <a href="mailto:virendersiddhart24@gmail.com">virendersiddharth24@gmail.com</a> {" "} or through this form.</p>
            ...
            >
                ...
                <div>
                    <textarea name="" id="" cols="30" rows="10" placeholder='Your Message'
                        className='w-full bg-none outline-none border-2 py-2 px-3 rounded-xl h-[180px]'
                    ></textarea>
                </div>

                <motion.button className='flex justify-center w-[120px] items-center gap-1
                    bg-rich-purple-700 text-white py-2 px-3 rounded-lg hover:bg-rich-purple-900 transition-all duration-200 group
                '
                    onClick={(e)=>{e.preventDefault(); console.log("Submit Clicked")}}
                    whileTap={{scale: "0.9"}}
                >
